...
// ==== Challenge 1 ====
// The dealer can't recall the information for a car with an id of 33 on his lot. Help the dealer find out which car has an id of 33 by logging the car's year, make, and model 
...
for (let i = 0; i < inventory.length; i++){
    ...
    let alphabeticalOrder = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z"];

    let carModels = [inventory[i].car_model];
        if (carModels > alphabeticalOrder.length) {
        }
